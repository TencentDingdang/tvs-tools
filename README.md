...
使用流程如下：
（1）安装ASRNLU_demo.apk，
（2）将tsr整个目录放到手机/sdcard/tencent/dingdang/res/目录下。
（3）测试音频文件，存放到/sdcard/tencent/test/tsr/wav/目录下。
（4）运行App，点击“测试”按钮，开始测试。
（5）测试完成后，测试报告存放在/sdcard/tencent/test/tsr/out/目录下。

...
使用设备的伴生`APP`对设备的提醒数据进行管理（新增、删除、修改、查询），下面将以“主控设备”代指“伴生`APP`”，“受控设备”代指设备本体。
...
```json
{
    ...
    "stCloudAlarmReq":{
      ...
      "eCloud_type":0,						// 管理类型， 具体参见 E_CLOUD_REMINDER_OPT
    }
}
```
#### 参数描述

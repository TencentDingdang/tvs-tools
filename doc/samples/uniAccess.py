...
jsonReq["payload"]["jsonBlobInfo"]="{\"xxxname\":\"xxxname\",\"xxxname2\":110}";
...
# **** 发送请求 *****
requestUrl = 'https://aiwx.html5.qq.com/api/v1/uniAccess'
...
reqTime = time.time();
# **** 请注意控制台打印的body内容，payload.jsonBlobInfo是字符串类型的 *****

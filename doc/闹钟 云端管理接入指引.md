...
使用设备的伴生`APP`对设备的闹钟数据进行管理（新增、删除、修改），下面将以“主控设备”代指“伴生`APP`”，“受控设备”代指设备本体。

以云端数据为准，同步云端闹钟数据请参见 [uniAccess接口能力](https://github.com/TencentDingdang/tvs-tools/blob/master/doc/uniAccess接口能力.md) 第三小节。
